const Necklace = {
    names: [
        "Midnight Goldstone Gala Necklace",
        'Mystic Topaz Saana Necklace',
        'Rose Quartz Akoni Necklace',
        "Semi-precious Ruby Rhea Necklace",
        'Moonstone Eden Necklace',
        'Turquoise Cassia Necklace',
        'Midnight Goldstone Cassia Necklace',
        'Turquoise Signe Necklace',
        'Moonstone Akoni Necklace Drop',
        'Garnet Cassandra Necklace',
        'Opal Araceli Necklace',
        'Labradorite Alta Necklace',
        'Amethyst Akoni Necklace',
        'Turquoise Alta Necklace',
        'Chakra Necklace',
        'Aquamarine Alta Necklace Round',
        'Amethyst Astrid Necklace',
        'Mystic Topaz Ari Necklace Oval'
    ],
    prices: [

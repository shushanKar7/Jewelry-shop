const Ring = {
    names: [
        'Mystic Topaz Saana Ring',
        "Midnight Goldstone Gala Ring",
        "Semi-precious Ruby Rhea Ring",
        'Moonstone Eden Ring',
        'Rose Quartz Akoni Ring',
        'Turquoise Cassia Ring',
        'Turquoise Signe Ring',
        'Midnight Goldstone Cassia Ring',
        'Garnet Cassandra Ring',
        'Moonstone Akoni Ring Drop',
        'Labradorite Alta Ring',
        'Opal Araceli Ring',
        'Amethyst Akoni Ring',
        'Chakra Ring',
        'Turquoise Alta Ring',
        'Aquamarine Alta Ring Round',
        'Mystic Topaz Ari Ring Oval',
        'Amethyst Astrid Ring'

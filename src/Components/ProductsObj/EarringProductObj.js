const Earring = {
    names: [
        'Mystic Topaz Ari Earring Oval',
        'Mystic Topaz Saana Earring',
        'Rose Quartz Akoni Earring',
        'Moonstone Akoni Earring Drop',
        "Semi-precious Ruby Rhea Earring",
        'Moonstone Eden Earring',
        'Turquoise Cassia Earring',
        'Midnight Goldstone Cassia Earring',
        'Turquoise Signe Earring',
        'Garnet Cassandra Earring',
        "Midnight Goldstone Gala Earring",
        'Aquamarine Alta Earring Round',
        'Opal Araceli Earring',
        'Amethyst Akoni Earring',
        'Labradorite Alta Earring',
        'Turquoise Alta Earring',
        'Chakra Earring',
        'Amethyst Astrid Earring',
    ],
    prices: [
